...
| Variable | Default | Notes |
| --- | --- | --- |
| `ARTA_TELEMETRY` | `1` | `0` = zero network calls (air-gap safe); fields documented in [docs/TELEMETRY.md](https://github.com/AmeyaAI/OPEN-ARTA/blob/main/docs/TELEMETRY.md) |

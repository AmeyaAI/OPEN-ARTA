...
const site = 'https://dpod-labs-private-limited.github.io';
...
export default defineConfig({
	...
	integrations: [
		starlight({
			...
			social: [
				{ icon: 'github', label: 'GitHub', href: 'https://github.com/Dpod-Labs-Private-Limited/OPEN-ARTA' },
			],
			editLink: {
				baseUrl: 'https://github.com/Dpod-Labs-Private-Limited/OPEN-ARTA/edit/main/website/',
			},
			customCss: [

// Vendored from https://gc.zgo.at/count.js (self-hosted so no third-party script
// executes on the site; data still goes to the hosted endpoint). Refresh occasionally.
